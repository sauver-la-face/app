[Onboarding](docs/onboarding.md) · [Architecture](docs/architectureAdr.md) · [Schéma BDD](docs/schema.dbml) · [Lexique](docs/lexique.md) · [CDC](docs/cdc.md) · [Contexte IA](.ai/context.md) · [Features](.ai/features.md)
...
- [Architecture](docs/architectureAdr.md) — décisions techniques et pourquoi elles ont été prises
